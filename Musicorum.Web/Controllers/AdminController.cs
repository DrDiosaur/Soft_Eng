...
namespace Musicorum.Web.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public AdminController(IEmailSender emailSender, INewsService newsService, ISongService songService, IGenreService genresService, IEventService eventService)
        {
