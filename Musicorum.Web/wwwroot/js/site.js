$(document).ready(function () {
    ...
    $(document).on('click', '.event-page-media-btns .menu-item', function () {
        if (!$(this).hasClass('active')) {
            const activetab = this.classList[1];

            const menuTabs = $('.event-page-media-btns').find('.menu-item');
            const contentTabs = $('.event-page-media-content').find('.content-item');
